<%@ Page Title="" Language="C#" MasterPageFile="~/ReportingEngine.Master" AutoEventWireup="true" CodeBehind="StepOne.aspx.cs" Inherits="PTAWMS.Reports.Filters.StepOne" %>
                ...
                <div class="col-md-8">
                    <div class="row" id="divDate">
                        <div class="col-md-6">
                            ...
                            <input id="dateFrom" name="dateFrom" class="input-sm" runat="server" type="date" />
                        </div>
                        <div class="col-md-6">
                            <span class="h5">To :</span>
                            <input id="dateTo" class="input-sm" runat="server" type="date" />
                        </div>
                        <hr />
                    </div>
                    ...
                    <div class="row col-md-12">
                        ...
                        <% if (user.HRModule == true)
                            {%>
                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-sm btn-primary wrap" OnClick="btnStepOne_Click" ToolTip="Stations, Divisions">Location</asp:LinkButton>
                            ...
                            <% {%>
                            <asp:LinkButton ID="btnStepOne" runat="server" CssClass="btn btn-sm btn-primary wrap" OnClick="btnStepOne_Click">Stations, Divisions</asp:LinkButton>
                    ...
                    <div class="row  col-md-12">
                        <div class="filterHeader">
                            <span class="h4">Stations</span>
                            <span style="margin-left: 10px">
                                <asp:TextBox ID="tbSearch_Location" CssClass="input-sm" runat="server" />
                                <asp:Button ID="Button2" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchLocation_Click" />
                    ...
                    <div class="row col-md-12">
                        <br />
                        <div class="filterHeader">
                            <span class="h4">Divisions</span>
                            <span style="margin-left: 10px">
                                <asp:TextBox ID="TextBoxSearchDepartment" CssClass="input-sm" runat="server" />
                                <asp:Button ID="Button1" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchDepartment_Click" />
                            </span>
                        </div>
                        <br />
                        <section>
                            <asp:GridView ID="GridViewDepartment" runat="server" Width="450px" AutoGenerateColumns="False" PagerStyle-CssClass="pgr" CssClass="Grid" GridLines="None" AllowPaging="True" AllowSorting="True" Font-Size="12px" OnPageIndexChanging="GridViewDepartment_PageIndexChanging" ForeColor="Black" OnRowDataBound="GridViewDepartment_RowDataBound" ShowFooter="True">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
