<%@ Page Title="" Language="C#" MasterPageFile="~/ReportingEngine.Master" AutoEventWireup="true" CodeBehind="StepTwo.aspx.cs" Inherits="PTAWMS.Reports.Filters.StepTwo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                ...
                Select Employement Types &amp; Attendance Shifts
                </small>
            </h1>
        </div>
        <!-- /.page-header -->
            ...
            <div class="col-md-12">
                <div class="col-md-8">
                    ...
                    <div class="row col-md-12">
                        ...
                        <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-sm  btn-primary" OnClick="btnStepTwo_Click" ToolTip="Types, Domicile, Shifts">Category</asp:LinkButton>
    ...
    { %>
                        ...
                        <% {%>   
                        <asp:LinkButton ID="btnStepOne"  runat="server" CssClass="btn btn-sm btn-grey wrap" OnClick="btnStepOne_Click" >Stations, Divisions</asp:LinkButton>
                        <asp:LinkButton ID="btnStepTwo" runat="server" CssClass="btn btn-sm  btn-primary" OnClick="btnStepTwo_Click" >Types, Shifts</asp:LinkButton>
                    ...
                    <div class="row col-md-12">
                        <div class="filterHeader">
                            <span class="h4">Employee Types</span>
                            <span style="margin-left:10px">
                                <asp:TextBox ID="tbSearch_Type" CssClass="input-sm" runat="server" />
                                <asp:Button ID="Button1" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchType_Click" />
                        ...
                        <br/> 
                        <section>
                            <asp:GridView ID="GridViewType" runat="server" Width="550px" AutoGenerateColumns="False" PagerStyle-CssClass="pgr" CssClass="Grid"                              GridLines="None" AllowPaging="True" AllowSorting="True" Font-Size="12px"                                               OnPageIndexChanging="GridViewType_PageIndexChanging" ForeColor="Black" OnRowDataBound="GridViewType_RowDataBound" ShowFooter="True"  >
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:BoundField DataField="TypID" HeaderText="ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                     ...
                     <div class="row  col-md-12">
                        <div class="filterHeader"><span class="h4">Domicile</span>
                            <span style="margin-left:10px">
                                <asp:TextBox ID="tbSearchDomicile" CssClass="input-sm" runat="server" /> <asp:Button ID="Button4" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchDomicile_Click" />
                                <asp:Button ID="Button5" runat="server" style="margin-top:18px" Text="Clear All Filters" CssClass="btn-warning" OnClick="ButtonDeleteAll_Click" />
                            </span>
                        </div>
                        <br/> 
                        <section>
                            <asp:GridView ID="GridViewDomicile" runat="server" Width="450px" AutoGenerateColumns="False" PagerStyle-CssClass="pgr" CssClass="Grid"                              
                                GridLines="None" AllowPaging="True" AllowSorting="True"                                                
                                OnPageIndexChanging="GridViewDomicile_PageIndexChanging" BorderColor="#0094FF" BorderStyle="None" OnRowDataBound="GridViewDomicile_RowDataBound" ShowFooter="True" BorderWidth="1px"  Font-Size="12px">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:BoundField DataField="DomicileProvince" HeaderText="ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%--<asp:CheckBox ID="CheckAll" runat="server" />--%>
                                        ...
                                        <asp:BoundField DataField="DomicileProvince" HeaderText="Domicile" />
                                </Columns>
                                <EditRowStyle BackColor="#999999" />
                                <FooterStyle BackColor="#EEEEEE" Font-Bold="False" ForeColor="Black" Wrap="False" />
                    ...
                    <br />
                        <div class="filterHeader">
                            <span class="h4">Shifts</span>
                            <span style="margin-left:10px">
                                <asp:TextBox ID="tbSearch_Shift" CssClass="input-sm" runat="server" />
                                <asp:Button ID="Button2" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchShift_Click" />
                            </span>
                        </div>
                        <br/>
                        <section>
                            <asp:GridView ID="GridViewShift" runat="server" Width="450px" AutoGenerateColumns="False" PagerStyle-CssClass="pgr" CssClass="Grid"                              
                                GridLines="None" AllowPaging="True" AllowSorting="True" Font-Size="12px"                                               
                                OnPageIndexChanging="GridViewShift_PageIndexChanging" BorderColor="#0094FF" BorderStyle="None" OnRowDataBound="GridViewShift_RowDataBound" ShowFooter="True" BorderWidth="1px"  >
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:BoundField DataField="ShftID" HeaderText="ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%--<asp:CheckBox ID="CheckAll" runat="server" />--%>
                            ...
                            {
                                {
                                    ...
                                    Response.Write("<div class='panel panel-default'><div class='panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#Div10' href='#collapseCrew'>Degree</a> <i class='ace-icon fa fa-arrow-down'></i><span style ='float:right;' class='badge' id ='DegreeSpan'>" + d + "</span></h4></div><div id='collapseCrew' class='panel-collapse collapse out'><div class='list-group'>");
                                }
                            ...
                            {
                                {
                                    ...
                                    Response.Write("<div class='panel panel-default'><div class='panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#Div11' href='#collapseCrew'>Institute</a> <i class='ace-icon fa fa-arrow-down'></i><span style ='float:right;' class='badge' id ='InstituteSpan'>" + d + "</span></h4></div><div id='collapseCrew' class='panel-collapse collapse out'><div class='list-group'>");
                                }
    ...
    <%--<script src="../../assets/js/jquery-2.1.4.min.js"></script>
     <script type="text/javascript">
         ...
         $(document).ready(function () {
             ...
             if ($("#ContentPlaceHolder1_hidDateFilter").val() == "1") {
                 $('#chkDate').attr('checked', 'checked')
                 $("#divDate").show();
             }
             else if ($("#ContentPlaceHolder1_hidDateFilter").val() == "0") {
                  $('#chkDate').attr('checked', '');
                 $("#divDate").hide();
             }
             ...
             $('#chkDate').click(function () {
                 ...
                 if (this.checked) {
                     filterFlag = "true";
                     $("#ContentPlaceHolder1_hidDateFilter").val("1");
                     $("#divDate").show();
                 }
                 else {
                     filterFlag = "false";
                     $("#ContentPlaceHolder1_hidDateFilter").val("0");
                     $("#divDate").hide();
                 }
             });
