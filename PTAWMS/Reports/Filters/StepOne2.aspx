<%@ Page Title="" Language="C#" MasterPageFile="~/ReportingEngine.Master" AutoEventWireup="true" CodeBehind="StepOne2.aspx.cs" Inherits="PTAWMS.Reports.Filters.StepOne2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    { %>
                        ...
                        <% if (user.UserType=="A" || user.UserType=="H" ||user.UserType=="E")
                             {%>
                    <div class="row  col-md-12">
                        <div class="filterHeader"><span class="h4">Stations</span>
                            <span style="margin-left:10px"><asp:TextBox ID="tbSearch_Location" CssClass="input-sm" runat="server" /> <asp:Button ID="Button2" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchLocation_Click" />
