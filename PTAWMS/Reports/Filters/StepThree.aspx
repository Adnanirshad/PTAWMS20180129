<%@ Page Title="" Language="C#" MasterPageFile="~/ReportingEngine.Master" AutoEventWireup="true" CodeBehind="StepThree.aspx.cs" Inherits="PTAWMS.Reports.Filters.StepThree" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                ...
                Select Departments &amp; Common Designations
                </small>
            </h1>
        </div>
        <!-- /.page-header -->
            ...
            <div class="col-md-12">
                <div class="col-md-8">
                    ...
                    <div class="row col-md-12">
                        ...
                        <asp:LinkButton ID="LinkButton6" runat="server"  CssClass="btn btn-sm  btn-primary" OnClick="btnStepThree_Click" ToolTip="Department, Designations">Posting</asp:LinkButton>
                       <% if (Convert.ToString(Session["ReportMenu"]) == "HRMS")
                            {%>
    ...
    { %>
                        ...
                        <asp:LinkButton ID="btnStepThree" runat="server"  CssClass="btn  btn-sm btn-primary" OnClick="btnStepThree_Click" >Department, Designations</asp:LinkButton>
                    ...
                    <div class="row col-md-12">
                        <div class="filterHeader">
                            ...
                            <span style="margin-left:10px">
                                <asp:TextBox ID="tbSearch_Section" CssClass="input-sm" runat="server" />
                                <asp:Button ID="Button1" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchSection_Click" />
                        ...
                        <br/> 
                        <section>
                            <asp:GridView ID="GridViewSection" runat="server" Width="450px" AutoGenerateColumns="False" PagerStyle-CssClass="pgr" CssClass="Grid"                              GridLines="None" AllowPaging="True" AllowSorting="True"                                                OnPageIndexChanging="GridViewSection_PageIndexChanging" ForeColor="Black" OnRowDataBound="GridViewSection_RowDataBound" ShowFooter="True" Font-Size="12px" >
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:BoundField DataField="SecID" HeaderText="ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                    ...
                    <div class="row col-md-12">
                        <br/> <br/> 
                        <div class="filterHeader">
                            <span class="h4">Designations</span>
                            <span style="margin-left:10px">
                                <asp:TextBox ID="tbSearch_Designation" CssClass="input-sm" runat="server" />
                                <asp:Button ID="Button2" runat="server" Text="Search" CssClass="btn-primary" OnClick="ButtonSearchDesignation_Click" />
                            </span>
                        </div>
                        <br/> 
                        <section>
                            <asp:GridView ID="GridViewDesignation" runat="server" Width="450px" AutoGenerateColumns="False" PagerStyle-CssClass="pgr" CssClass="Grid"                              GridLines="None" AllowPaging="True" AllowSorting="True"                                                OnPageIndexChanging="GridViewDesignation_PageIndexChanging" BorderColor="#0094FF" BorderStyle="None" OnRowDataBound="GridViewDesignation_RowDataBound" ShowFooter="True" BorderWidth="1px"  Font-Size="12px">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:BoundField DataField="DesigID" HeaderText="ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%--<asp:CheckBox ID="CheckAll" runat="server" />--%>
                                            <input style="margin-left:6px" id="chkAll" onclick="javascript: SelectAllCheckboxes(this, 'GridViewDesignation');" 
                                                runat="server" type="checkbox" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox style="margin-left:6px"  ID="CheckOne" runat="server" />
